"""
Legacy repository analyzer using file_walker, ast_parser, dependency_graph, architecture.
Kept for backward compatibility. Will be replaced component by component.
"""
